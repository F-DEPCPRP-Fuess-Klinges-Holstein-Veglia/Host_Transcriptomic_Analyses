...
##code used for GOMWU analyses of viral associations; this was used on each of our output files individually, changing the input accordingly.
...
mydata=read.csv("Terasakiellaceae_GOMWU.csv")
write.csv(mydata, file = "new_Terasakiellaceae_GOMWU.csv", append = FALSE, quote = FALSE, sep = " ",
          eol = "\n", na = "NA", dec = ".", row.names = FALSE,
          col.names = FALSE, qmethod = c("escape", "double"),
          fileEncoding = "")

# Edit these to match your data file names:
##each microbial family is run independently
input="new_Terasakiellaceae_GOMWU.csv" # two columns of comma-separated values: gene id, continuous measure of significance. To perform standard GO enrichment analysis based on Fisher's exact test, use binary measure (0 or 1, i.e., either sgnificant or not).
