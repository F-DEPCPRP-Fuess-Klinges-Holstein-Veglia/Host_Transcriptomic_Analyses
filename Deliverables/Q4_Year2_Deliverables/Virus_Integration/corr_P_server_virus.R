##this code runs our correlations generating a pvalue for each comparison
...
##input data##
Vir_Corr = read.csv("final_correlation_matrix_order.csv", row.names=1)
##and run it! (will take a while.. that's a lot of pairwise correlations to make!##
p=cor.test.p(Vir_Corr)
warnings()
